...
// 		alert("delete");
		top.$.jBox.open("get:addBanner.jsp",null,700,500,{ buttons:{"提交":"ok", "取消":true, "关闭":true}, submit:function(v, h, f){
...
// 			$(".jbox-content", top.document).css("overflow-y","hidden");
	...
	$("[id^=modify]").click(function(){
		top.$.jBox.open("get:addBanner.jsp",null,700,500,{ buttons:{"修改":"ok", "取消":true, "关闭":true}, submit:function(v, h, f){
			if (v=="ok"){
        		var selectType = h.find("#selectType").val();
        		var movieName =h.find("#movieName").val();
...
// 	alert(n+"  "+s);
	$.ajax({ url: "${pageUrl}",
		dataType: "text",
		data:{pageSize:s,pageNo:n,count:$("#btnQuery").length},
		success: function (data) {
