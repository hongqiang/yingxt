...
<body>
	...
	<div class="header"><%String error = (String) request.getAttribute(FormAuthenticationFilter.DEFAULT_ERROR_KEY_ATTRIBUTE_NAME);%>
		<div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>"><button data-dismiss="alert" class="close">×</button>
			<label id="loginError" class="error"><%=error==null?"":"com.jianxin.yingxt.web.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
		</div>
	</div>
	<h1 class="form-signin-heading">欢迎访问Wap管理系统</h1>
	<form id="loginForm" class="form-signin" action="#" method="post">
		...
		<input class="btn btn-large btn-primary" type="submit" value="登 陆"/>&nbsp;&nbsp;<input class="btn btn-large btn-primary" type="reset" value="重 置" style="float:right"/>
	</form>
	Copyright &copy; All rights reserved. 建新科技 版权所有&copy;<br/>地址：北京海淀区上地信息产业基地上地四街1号
</body>
</html>